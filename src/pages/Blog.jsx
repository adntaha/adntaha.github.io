      ...
      <ul className="col-span-3 col-start-1 row-span-3 row-start-1 flex flex-col gap-2.5 bg-(--background) p-5">
        {
          Posts
            ...
            .map((post, index) => (
              <li key={index} className="hover:-mt-0.5 transition-all duration-150">
                <Link href={"/blog/" + post.route} className="flex flex-row justify-between border-2 border-(--border) p-2.5 shadow rounded-xl">
